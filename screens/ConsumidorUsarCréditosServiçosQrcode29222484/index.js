    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_69_24}>
        ...
        <ImageBackground
          ...
          style={styles.ImageBackground_I69_24_6_11}
        />
        <View style={styles.View_I69_24_12_2}>
          <Text style={styles.Text_I69_24_12_2}>Crédito Fiscal</Text>
        </View>
        <View style={styles.View_I69_24_26_68}>
          <Text style={styles.Text_I69_24_26_68}>Consumidor</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I69_24_22_0}
        />
        <View style={styles.View_I69_24_106_0}>
          <Text style={styles.Text_I69_24_106_0}>São José dos Campos</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I69_24_301_2401}
        />
      </View>
      <View style={styles.View_69_25}>
        <Text style={styles.Text_69_25}>Usar créditos</Text>
      </View>
      <View style={styles.View_69_26} />
      <View style={styles.View_69_27}>
        <View style={styles.View_I69_27_37_362}>
          <View style={styles.View_I69_27_37_361} />
          <View style={styles.View_I69_27_36_398}>
            <Text style={styles.Text_I69_27_36_398}>
          ...
          <ImageBackground
            ...
            style={styles.ImageBackground_I69_27_36_397}
          />
        </View>
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_I69_27_39_5}
        />
      </View>
      <View style={styles.View_69_28}>
        <View style={styles.View_I69_28_33_227}>
          <View style={styles.View_I69_28_33_227_31_265} />
        </View>
        <View style={styles.View_I69_28_33_324}>
          <Text style={styles.Text_I69_28_33_324}>Sair</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I69_28_33_212}
        />
      </View>
      <View style={styles.View_69_29}>
        <View style={styles.View_I69_29_33_150}>
          <View style={styles.View_I69_29_33_150_31_265} />
        </View>
        <View style={styles.View_I69_29_33_321}>
          <Text style={styles.Text_I69_29_33_321}>Voltar</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I69_29_33_180}
        />
      </View>
      <View style={styles.View_69_30}>
        <Text style={styles.Text_69_30}>
          Mostre o QRCode para o Prestador de serviço O valor só será debitado
          caso o Prestador leia o QRCode e confirme o pagamento
        </Text>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_69_43}
      />
      <View style={styles.View_106_447}>
        <Text style={styles.Text_106_447}>Pagar Serviço/Produto</Text>
      </View>
      <View style={styles.View_122_77}>
        <View style={styles.View_122_78}>
          <Text style={styles.Text_122_78}>Saldo atual</Text>
        </View>
        <View style={styles.View_122_79}>
          <Text style={styles.Text_122_79}>R$ 267,00</Text>
        </View>
      </View>
      <View style={styles.View_122_80}>
        <View style={styles.View_122_81}>
          <Text style={styles.Text_122_81}>Saldo</Text>
        </View>
        <View style={styles.View_122_82}>
          <Text style={styles.Text_122_82}>R$ 244,50</Text>
        </View>
      </View>
      <View style={styles.View_140_3}>
        <View style={styles.View_122_84}>
          <Text style={styles.Text_122_84}>Valor a pagar</Text>
        </View>
        <View style={styles.View_122_86}>
          <Text style={styles.Text_122_86}>R$ 22,50</Text>
        </View>
      </View>
      <ImageBackground
        source={{
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_132_9}
      />
      <View style={styles.View_140_4}>
        <View style={styles.View_140_5}>
          <View style={styles.View_140_6} />
          <View style={styles.View_140_7}>
            <Text style={styles.Text_140_7}>OK</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I69_24_301_2401: {
    flexGrow: 1,
  ...
  View_69_30: {
    width: wp("99.44444444444444%"),
    minWidth: wp("99.44444444444444%"),
