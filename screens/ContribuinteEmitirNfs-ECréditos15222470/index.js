...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_66_135} />
      <View style={styles.View_66_136}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/c0ea/b08d/42a62f338b8c6a315126242503052db0"
          }}
          style={styles.ImageBackground_I66_136_106_665}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_136_106_666}
        />
        <View style={styles.View_I66_136_106_667}>
          <Text style={styles.Text_I66_136_106_667}>Crédito Fiscal</Text>
        </View>
        <View style={styles.View_I66_136_106_668}>
          <Text style={styles.Text_I66_136_106_668}>Contribuinte</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_136_106_669}
        />
        <View style={styles.View_I66_136_103_360}>
          <Text style={styles.Text_I66_136_103_360}>São José dos Campos</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_136_301_2693}
        />
      </View>
      <View style={styles.View_66_137}>
        <View style={styles.View_I66_137_43_664}>
          <View style={styles.View_I66_137_43_665} />
          <View style={styles.View_I66_137_43_666}>
            <Text style={styles.Text_I66_137_43_666}>
        ...
        <ImageBackground
          ...
          style={styles.ImageBackground_I66_137_43_732}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_137_43_731}
        />
      </View>
      <View style={styles.View_66_138}>
        <View style={styles.View_I66_138_33_227}>
          <View style={styles.View_I66_138_33_227_31_265} />
        </View>
        <View style={styles.View_I66_138_33_324}>
          <Text style={styles.Text_I66_138_33_324}>Sair</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_138_33_212}
        />
      </View>
      <View style={styles.View_66_139}>
        <View style={styles.View_I66_139_33_150}>
          <View style={styles.View_I66_139_33_150_31_265} />
        </View>
        <View style={styles.View_I66_139_33_321}>
          <Text style={styles.Text_I66_139_33_321}>Voltar</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I66_139_33_180}
        />
      </View>
      <View style={styles.View_66_176}>
        <Text style={styles.Text_66_176}>Receber Créditos Fiscais</Text>
      </View>
      <View style={styles.View_67_6}>
        <Text style={styles.Text_67_6}>
          Aponte a câmera para o QR code gerado pelo consumidor
        </Text>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_67_15}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_132_17}
      />
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I66_136_106_665: {
    flexGrow: 1,
    width: wp("100%"),
    height: hp("9.375%"),
    marginLeft: 0,
  ...
  ImageBackground_I66_136_106_666: {
    flexGrow: 1,
    width: wp("17.5%"),
  ...
  ImageBackground_I66_136_106_669: {
    flexGrow: 1,
    width: wp("100%"),
  ...
  ImageBackground_I66_136_301_2693: {
    flexGrow: 1,
  ...
  ImageBackground_I66_137_43_732: {
    flexGrow: 1,
    width: wp("5%"),
    height: hp("1.875%"),
    marginLeft: 0,
  ...
  ImageBackground_I66_137_43_731: {
    flexGrow: 1,
  ...
  ImageBackground_I66_138_33_212: {
    flexGrow: 1,
    width: wp("5%"),
  ...
  ImageBackground_I66_139_33_180: {
    flexGrow: 1,
